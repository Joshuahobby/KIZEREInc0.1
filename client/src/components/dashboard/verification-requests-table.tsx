      ...
      <CardContent>
        {!requests || requests.length === 0 ? (
          <div className="text-center py-10">
            <p className="text-muted-foreground italic">No pending verification requests found.</p>
          </div>
        ) : (
          <Table>
            <TableHeader>
                  ...
                  <TableCell className="text-right">
                    <Dialog>
                      ...
                      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                        <DialogHeader>
                          <DialogTitle>Verification Review: {request.user.fullName}</DialogTitle>
                          <DialogDescription>
                            Inspect the provided documents before approving or rejecting.
                          </DialogDescription>
                        </DialogHeader>
